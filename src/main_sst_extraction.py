    ...
    if( ('IDESessionUUID' in dict_param) and ('TriggeredAt' in dict_param) and ('Context2' in dict_param)):
        ...
        if('SST' in cont_dict):
            ...
            if(('Methods' in sst_dict) and ('Delegates' in sst_dict) and ('Properties' in sst_dict) and ('Fields' in sst_dict) and ('Events' in sst_dict)):
               ...
               for meth_body_ in prop_ls:           ### THIS WILL CHANGE FOR METHODS, DELEGATES, PROPETIES, FIELDS
...
if __name__=='__main__':
   ...
   ## FOLOWWING IS DONE
   file2save = '/Users/akond/Documents/AkondOneDrive/MSR18-MiningChallenge/output/ALL_PROPERTY_COMPLEXITY_CONTENT.csv'
   key_to_look = 'sst'
